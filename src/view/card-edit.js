...
const createCardEditDateTask = (dueDate) => {
...
const createCardEditColorsTask = (currentColor) => {
...
export const createCartEditTask = (task = {}) => {
  const {
    color = ``,
    description = ``,
    dueDate = null,
  ...
  const dateTemplate = createCardEditDateTask(dueDate);
